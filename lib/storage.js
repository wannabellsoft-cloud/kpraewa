...
const DEFAULT_SETTINGS = {
  ...
  jar: {
    theme: 'glass',         // 'glass' | 'lab'
    minDiamonds: 0,         // skip gifts whose diamondCount is below this
    baseSize: 56,           // px — base size of a single gift
    scaleByDiamonds: true   // grow gifts that cost more
  }
};
